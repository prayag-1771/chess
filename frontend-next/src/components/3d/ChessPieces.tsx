...
function queenGeometry(): THREE.BufferGeometry {
  return lathe([
    [0, 0], [0.42, 0], [0.42, 0.06], [0.36, 0.10], [0.22, 0.16],
    [0.18, 0.26], [0.16, 0.58], [0.15, 0.96], [0.14, 1.14], [0.13, 1.28],
    [0.19, 1.32], [0.24, 1.36], [0.26, 1.42], [0.28, 1.58],
    [0.32, 1.62], [0.34, 1.68], [0.32, 1.74], [0.18, 1.78],
    [0.08, 1.84], [0.12, 1.88], [0, 1.95],
  ])
}

function kingBodyGeometry(): THREE.LatheGeometry {
  return lathe([
    [0, 0], [0.44, 0], [0.44, 0.06], [0.38, 0.10], [0.24, 0.16],
    [0.20, 0.28], [0.18, 0.60], [0.16, 1.00], [0.15, 1.20], [0.14, 1.34],
    [0.22, 1.38], [0.28, 1.44], [0.30, 1.52], [0.28, 1.64],
    [0.24, 1.74], [0.18, 1.84], [0, 1.84],
  ])
}
